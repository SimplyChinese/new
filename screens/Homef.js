...
import { StyleSheet, Button, Text, View, Image, Modal, ScrollView, SafeAreaView, ImageBackground, TouchableOpacity, RefreshControl, Share } from 'react-native';
...
const Exambox = ()=> {
  return(
    <View style={styles.botele} >
                ...
                <View style={{ justifyContent:'center', backgroundColor: '#ffede8', borderWidth: 1, borderRadius:50, borderColor: '#ffede8', height: 25, width: 25, padding: 20, }}><Image source={require('../assets/test.png')} style={{ width: 25, height: 25, margin:-10}} /></View>
        ...
        <View style={styles.botele} >
          ...
          <Modal transparent={true} visible={this.state.show}> 
            <View style={{backgroundColor: '#000000aa', flex:1}}>
              <View style={{backgroundColor: '#fff', margin: 10, padding: 20, borderRadius: 10, flex: 1}}>
                <View style={{flexDirection: 'row', justifyContent: 'space-between', backgroundColor: '#ffffff'}}><View onStartShouldSetResponder={() => {this.setState({show:false})} }><Image source={require('../assets/backarrow.png')} style={{height: 30, width: 30}} /></View></View>
                <View  style={{marginTop: 20, flexWrap : 'wrap'}}>
                  <Text style={{fontSize: 40}}>Alerts Screen text</Text>
                  <View style={{marginVertical: 20}}><Image source={require('../assets/alertscreen.jpg')} style={{width: 335}}  /></View>
                  <DummyTxt />
                  <DummyTxt />
                  <DummyTxt />
                  <DummyTxt />
        ...
        <View style={styles.maincontent}>
          ...
          >
            ...
            <View style={{ marginBottom: 40 }} >
              <Text style={styles.nameText} >Miss Anushka Shrinivasan</Text>
            </View>
