    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.responsiveBox}>
          ...
          <Text style={styles.texttwo}>We will send you One Time Code </Text>
          <Text style={styles.texttwo}>on your  phone Number</Text>
          </View>
            ...
            <View onStartShouldSetResponder={() => navigation.navigate('Otplogintwo')} style={styles.logbtn}><Text style={{color: '#fff', fontWeight: 'bold'}}>GET OTP</Text></View>
            </View>
        </ScrollView>
      </SafeAreaView>
    );
